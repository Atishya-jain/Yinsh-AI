...
public:
	...
	pair<int,float> MinVal(vector<vector<pos>>& board, int current_depth, float alpha, float beta);
	pair<int,float> MaxVal(vector<vector<pos>>& board, int current_depth, float alpha, float beta);
